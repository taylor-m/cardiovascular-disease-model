...
if option == "Model":
    ...
    if model == "Classification":
        ...
        metrics = st.sidebar.multiselect("Classifier Visualization:", ('Calibration Curve', 'Confusion Matrix', 'Precision-Recall Curve', 'Feature Importances', 'Prediction Distribution'), key="xgb_metric")
